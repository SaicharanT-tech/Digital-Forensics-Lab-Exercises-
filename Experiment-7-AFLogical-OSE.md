...
![images/exp1-disk-step1.png](https://github.com/SaicharanT-tech/Digital-Forensics-Lab-Exercises-/blob/main/Images/7.1.png)

![images/exp1-disk-step1.png](https://github.com/SaicharanT-tech/Digital-Forensics-Lab-Exercises-/blob/main/Images/7.3.png)
---
...
![images/exp1-disk-step1.png](https://github.com/SaicharanT-tech/Digital-Forensics-Lab-Exercises-/blob/main/Images/7.13.jpeg)
...
1.  **Push the APK to the Android Device:**
    ...
    * Run the command to install the AFLogical OSE APK on the device:
        ...
        ```
![images/exp1-disk-step1.png](https://github.com/SaicharanT-tech/Digital-Forensics-Lab-Exercises-/blob/main/Images/7.7.png)
...
![images/exp1-disk-step1.png](https://github.com/SaicharanT-tech/Digital-Forensics-Lab-Exercises-/blob/main/Images/7.12.jpeg)

![images/exp1-disk-step1.png](https://github.com/SaicharanT-tech/Digital-Forensics-Lab-Exercises-/blob/main/Images/7.11.jpeg)
...
1.  **Use ADB to Pull Data:**
    * After extraction is complete, transfer the collected data files from the Android device to your computer using the `adb pull` command:
        ...
        ```
![images/exp1-disk-step1.png](https://github.com/SaicharanT-tech/Digital-Forensics-Lab-Exercises-/blob/main/Images/7.8.png)
...
![images/exp1-disk-step1.png](https://github.com/SaicharanT-tech/Digital-Forensics-Lab-Exercises-/blob/main/Images/7.9.png)
---
